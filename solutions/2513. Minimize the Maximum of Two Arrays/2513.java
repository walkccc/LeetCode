class Solution {
  public int minimizeSet(int divisor1, int divisor2, int uniqueCnt1, int uniqueCnt2) {
    ...
    while (l < r) {
      final long m = (l + r) / 2;
      if (isValid(m, divisorLcm, divisor1, divisor2, uniqueCnt1, uniqueCnt2))
        r = m;
      else
        l = m + 1;
    }
  ...
  private boolean isValid(long m, long divisorLcm, int divisor1, int divisor2, int uniqueCnt1,
                          int uniqueCnt2) {
