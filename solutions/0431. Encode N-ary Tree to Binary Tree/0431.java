class Codec {
  ...
  public TreeNode encode(Node root) {
    ...
    Queue<Pair<Node, TreeNode>> q = new LinkedList<>(Arrays.asList(new Pair<>(root, rootTreeNode)));
  ...
  public Node decode(TreeNode root) {
    ...
    Queue<Pair<Node, TreeNode>> q = new LinkedList<>(Arrays.asList(new Pair<>(rootNode, root)));
